...
namespace Peeters_Sam_r049890.Migrations
{
    ...
    [Migration("20220821191706_loggedinuser")]
    partial class loggedinuser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Peeters_Sam_r049890.Areas.Identity.Data.CustomUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Peeters_Sam_r049890.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Peeters_Sam_r049890.Areas.Identity.Data.CustomUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Peeters_Sam_r049890.Models.ShoppingCart", b =>
                {
                    b.HasOne("Peeters_Sam_r049890.Areas.Identity.Data.CustomUser", "CustomUser")
                        .WithMany()
